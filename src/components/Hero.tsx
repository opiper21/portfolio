    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-40 pb-32">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start mt-12">
          <div>
            ...
            <p className="text-lg md:text-xl leading-relaxed max-w-lg text-brown/80">
              I help{" "}
              <span className="font-semibold bg-burnt text-cream px-2 py-0.5">
                startups & small businesses
              </span>{" "}
              turn their ideas into <strong>fast, modern web apps</strong> that
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-24 pt-10 border-t-4 border-brown">
          <div>
            <p className="font-display text-4xl md:text-5xl text-burnt">3+</p>
            <p className="font-mono text-xs uppercase mt-2 font-bold tracking-wider">
              Years Experience
            </p>
          </div>
          <div>
            <p className="font-display text-4xl md:text-5xl text-burnt">25+</p>
            <p className="font-mono text-xs uppercase mt-2 font-bold tracking-wider">
              Projects Done
            </p>
          </div>
          <div>
            <p className="font-display text-4xl md:text-5xl text-burnt">15+</p>
            <p className="font-mono text-xs uppercase mt-2 font-bold tracking-wider">
              Happy Clients
            </p>
          </div>
          <div>
            <p className="font-display text-4xl md:text-5xl text-burnt">100%</p>
            <p className="font-mono text-xs uppercase mt-2 font-bold tracking-wider">
              Client Focused
            </p>
          </div>
      ...
      <div className="absolute bottom-0 left-0 w-full bg-brown text-cream py-4 border-y-4 border-brown overflow-hidden flex whitespace-nowrap">
        <div className="flex animate-marquee">
          {[...Array(3)].map((_, i) => (
            <span
              key={i}
              className="font-display uppercase text-lg mx-8 flex items-center gap-8 whitespace-nowrap"
            >
